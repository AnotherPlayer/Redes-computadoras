...
\includegraphics[width=0.9\textwidth]{./MsjTerminal1.png}
\newpage
...
\includegraphics[width=0.8\textwidth]{./MsjTerminal2.png}
...
\includegraphics[width=0.8\textwidth]{./MsjWireshark.png}
